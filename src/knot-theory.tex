...
The following theorem shows that Theorem 3.5.12 is not always almighty for showing primeness.
Theorem 3.5.18 No 2-bridge knot or torus knot can be presented as a tangle sum of two prime tangles.
The prooffollows from Theorem 3.5.17 and [Magnus-Karras-Solitar 1966(p. 211)].

In the old days, only special types of links could be judged to be prime by a technical reason. Since [Kirby-Lickorish 1979], tangle theory has been developed by several knot theorists to be a great machine which enables us to judge primeness and hyperbolicity, even for complicated links (cf. [Myers 1983], [Nakanishi 1981', 1983], [Soma 1983]), though the tangle theory is not all powerful for such judgment.

Murasugi sum: Kawauchi-96, strona 50
