...
Dowód przebiega analogicznie do dowodu ,,multiplikatywności'' wielomianów Alexandera (fakt \ref{prp:alexander_multiplicative}) oraz Jonesa (fakt \ref{prp:jones_multiplicative}).
