...
Jednocześnie równość \ref{kanenobu_rationality_test} nie zachodzi dla żadnego alternującego węzła złożonego oraz żadnego znanego (!) węzła złożonego.
...
Wiadomo, że zarówno wśród węzłów wymiernych, jak i niewymiernych, istnieją węzły nierozróżnialne od siebie przy pomocy wielomianu $F$.
