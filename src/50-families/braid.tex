...
Tylko grupy $B_2$ i $B_3$ mogą być grupami węzłów,
Wszystkie wyższe zawierają podgrupę izomorficzną z $\Z^3$, z generatorami $\sigma_1$, $\sigma_3$, $(\sigma_1 \sigma_2\sigma_3)^4$.
...
łamanymi, których rzuty do płaszyczyzny diagramu nie przecinają się.
