...
Hipoteza Millnora głosiła, że w rzeczywistości równość zachodzi zawsze.
...
\begin{proof}
    ...
    Inne podejście, tak zwaną formułę Seiferta-Torresa, prezentuje przeglądowa praca Turaeva ,,Reidemeister torsion in knot theory'', 119-182.
\end{proof}
