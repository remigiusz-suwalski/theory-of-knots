...
Przypomnijmy jeszcze definicję klasycznego niezmiennika powierzchni:
...
Nas interesują głównie powierzchnie Seiferta węzłów: jeśli $d$ oznacza liczbę dysków, zaś $b$ pasków, to $k_0 = 4b$, $k_1 = 6b$, zaś $k_2 = b+d$, zatem $2g = 1-d+b$.
