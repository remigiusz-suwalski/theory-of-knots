...
\[
    \sum_{i=1}^n \operatorname{cr} K_i \le N \cdot \operatorname{cr} \left(\bigshrap_{i=1}^n K_i\right).
\]
...
Po drugie, podwojenie węzła (poza specjalnymi przypadkami, jak pokazal Schubert) zwiększa liczbę mostową dwukrotnie; liczba gordyjska takiego podwojenia wynosi $1$.
